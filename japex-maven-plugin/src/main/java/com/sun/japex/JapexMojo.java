...
public class JapexMojo extends AbstractMojo {
    ...
    /**
     * The XML of the Japex config to run. This should contain a single testSuite element. (Multiple test
     * suites is a potential future enhancement). If you specify the configuration here, don't use
     * <strong>japexConfigFiles</strong>.
     * 
     * @parameter
     */
    ...
    /**
     * Pathnames of one or more japex configuration files. If you specify configuration files here, don't use
     * <strong>japexConfig</strong>.
     * 
     * @parameter
     */
    ...
    public void execute() throws MojoExecutionException {
        ...
        /**
         * Use the Japex class loader which knows how to find the japex classes relative to itself and
         * otherwise isolate.
         */
        ...
        if (japexConfig != null) {
            ...
            xmlWriter.setLocalRepositoryPathname(localRepository.getBasedir());
            try {
        ...
        try {
            ...
            printWriter.close();
            getLog().error("Error running driver", je);
